...
namespace cherryblossomtest.Core.UI
{
	// This ExampleUIHoverImageButton class inherits from UIImageButton. 
	// Inheriting is a great tool for UI design. 
	// By inheriting, we get the Image drawing, MouseOver sound, and fading for free from UIImageButton
	// We've added some code to allow the Button to show a text tooltip while hovered
	internal class UIHoverButton : UIImageButton
	{
		// Tooltip text that will be shown on hover
		internal string hoverText;

		public UIHoverButton(Asset<Texture2D> texture, string hoverText) : base(texture) {
