using cherryblossomtest.Content.Configs;
using cherryblossomtest.Core.Systems.ScreenTargetSystem;
using cherryblossomtest.Helpers;
using Terraria.Graphics.Effects;
using static cherryblossomtest.Helpers.DrawHelper;

namespace cherryblossomtest.Core.Systems.LightingSystem
{
