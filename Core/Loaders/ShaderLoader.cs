...
namespace StarlightRiver.Core.Loaders
{
	class ShaderLoader : IOrderedLoadable
	{
		...
		public void Load()
		{
			...
			var file = (TmodFile)info.Invoke(cherryblossomtest.cherryblossomtest.Instance, null);
		...
		{
			var screenRef = new Ref<Effect>(cherryblossomtest.cherryblossomtest.Instance.Assets.Request<Effect>(path, ReLogic.Content.AssetRequestMode.ImmediateLoad).Value);
